                  ...
                  <strong>Error!</strong>
                    ...
                    <div class="info-form">
                      <form>
                       ...
                       <button class="btn btn-primary" v-if="!this.product.actor_name" @click="createProduct()" ><span v-if="!creating">Create</span><span v-if="creating">Creating... Please wait </span></button>
                       <button class="btn btn-primary" v-if="this.product.actor_name" @click="updateProduct()" ><span v-if="!updating">Update</span><span v-if="updating">Updating... Please wait </span></button>
...
export default {
  ...
  methods: {
    ...
    createProduct(){  
      console.log("goes into create product");
